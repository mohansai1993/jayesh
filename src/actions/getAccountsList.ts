...
import {
    ...
    GOOGLE_ADS_LOAD_HIERARCHY_FAIL, GOOGLE_ADS_LOAD_HIERARCHY_SUCCESS, 
    GA4_LOAD_ACT_LIST_FAIL, GA4_LOAD_ACT_LIST_SUCCESS, 
    FB_INSIGHTS_LOAD_PAGES_LIST_FAIL, FB_INSIGHTS_LOAD_PAGES_LIST_SUCCESS,
    IG_INSIGHTS_LOAD_PROFILES_LIST_FAIL, IG_INSIGHTS_LOAD_PROFILES_LIST_SUCCESS
} from "./types";

export const getBingAdsAccountsList = (token_key: string) => async (dispatch: AppDispatch) => {
    try {
...
export const getFbAdsAccountsList = (token_key: string) => async (dispatch: AppDispatch) => {
    try {
        const res = await axios.get(
...
export const getFbInsightsPagesList = (user_token: string) => async (dispatch: AppDispatch) => {
    try {
        const res = await axios.get(
...
export const getGa4PropertiesList = (access_token: string) => async (dispatch: AppDispatch) => {
    try {
        const res = await axios.get(
...
export const getGoogleAdsAccountHierarchy = (token_key: string) => async (dispatch: AppDispatch) => {
    try {
        const res = await axios.get(
...
export const getSearchConsoleDomainsList = (access_token: string) => async (dispatch: AppDispatch) => {
    try {
        const res = await axios.get(
...
export const getIgProfilesList = (token_key: string) => async (dispatch: AppDispatch) => {
    try {
        const res = await axios.get(
