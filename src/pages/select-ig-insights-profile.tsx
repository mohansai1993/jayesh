                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {isCollapsed &&
                                                ...
                                                //}
                                                <div
                                                    key={igInsightsProfilesList[accountName]?.["profile_id"]}
                                                    className="select-account__child"
                                                >
                                                    {" "}
                                                    {igInsightsProfilesList[accountName]?.["profile_name"]}
                                                    <div
                                                        onClick={() =>
                                                            igProfileHandler(igInsightsProfilesList[accountName]?.["profile_id"], igInsightsProfilesList[accountName]?.["profile_name"])
                                                        }
