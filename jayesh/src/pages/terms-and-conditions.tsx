...
const TermsAndConditions = () => {
  return (
    <>
      <Layout
        title="Adzviser | Terms & Conditions"
        content="Our terms and conditions are designed to protect your rights and ensure a fair and transparent relationship between you and Adzviser. Read our terms and conditions to learn more about our policies and how they affect you.        "
      >
        <div className="privacyPolicy">
          <div className="container">
            <div>
              <p className="c28 privacyPolicy__title" id="h.mdrvsu4p7hne">
                <span className="c5 c19">Terms and Conditions</span>
              </p>
              <p className="c29">
                <span className="c1">Last updated: 2023-01-01</span>
              </p>

              <p className="c2 smallTitle">
                <span className="c5 ">TABLE OF CONTENTS</span>
              </p>
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.6lvneyv63v2q">
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.pvko3ii8f29u">
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.cqffusip6h2y">
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.wwcoyev1wvc8">
                    4. USER REGISTRATION
                  </a>
                </span>
              </p>
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.fw6146grth9a">
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.7kv3h2zscje">
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.1w9o5byhzfzq">
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.yesr57xnm9tu">
                    8. SUBMISSIONS
                  </a>
                </span>
              </p>
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.3crz3o3a6ij9">
                    9. SITE MANAGEMENT
                  </a>
                </span>
              </p>
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.wv7t1lobm9zb">
                    10. PRIVACY POLICY
                  </a>
                </span>
              </p>
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.xugo2edkhmv7">
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.iu1lqm4wjeyt">
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.eq4v54prchk1">
                    13. GOVERNING LAW
                  </a>
                </span>
              </p>
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.swgejc3g5tbm">
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.swgejc3g5tbmfifteen">
                    15. CORRECTIONS
                  </a>
                </span>
              </p>
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.swgejc3g5tbmsixteen">
                    16. DISCLAIMER
                  </a>
                </span>
              </p>
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.swgejc3g5tbmseventeen">
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.swgejc3g5tbmeighteen">
                    18. INDEMNIFICATION
                  </a>
                </span>
              </p>
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.swgejc3g5tbmnineteen">
                    19. USER DATA
                  </a>
                </span>
              </p>
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.swgejc3g5tbmtwenteen">
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.swgejc3g5tbmtwenteenone">
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.swgejc3g5tbmtwenteentwo">
                    22. MISCELLANEOUS
                  </a>
                </span>
              </p>
              ...
              <p className="c23">
                <span className="c12">
                  <a className="c4" href="#h.swgejc3g5tbmtwenteenthree">
                    23. CONTACT US
                  </a>
                </span>
              </p>

              <h1 className="c18" id="h.6lvneyv63v2q">
                <span className="c10 c5">1. AGREEMENT TO TERMS</span>
              </h1>
              ...
              <p className="c3">
                ...
                <span>
                  &quot;), concerning your access to and use of the adzviser.com
                  website as well as any other media form, media channel, mobile
                  website or mobile application related, linked, or otherwise
                  connected thereto (collectively, the &quot;Site&quot;). We are
                  registered in Delaware, United States and have our registered
                  office at 16192 Coastal Highway, Lewes, DE 19958. You agree
              ...
              <p className="c3">
                <span>
                  so if your interactions would be subjected to such laws, you
                  may not use this Site. You may not use the Site in a way that
              ...
              <h1 className="c18" id="h.pvko3ii8f29u">
                <span className="c10 c5">2. INTELLECTUAL PROPERTY RIGHTS</span>
              </h1>
              ...
              <h1 className="c18" id="h.cqffusip6h2y">
                <span className="c10 c5">3. USER REPRESENTATIONS</span>
              </h1>
              ...
              <h1 className="c18" id="h.wwcoyev1wvc8">
                <span className="c10 c5">4. USER REGISTRATION</span>
              </h1>
              ...
              <h1 className="c18" id="h.fw6146grth9a">
              ...
              <ul className="c8 lst-kix_3cy02djynox4-0 start">
              ...
              <h1 className="c18" id="h.7kv3h2zscje">
                <span className="c10 c5">6. USER GENERATED CONTRIBUTIONS</span>
              </h1>
              ...
              <h1 className="c18" id="h.1w9o5byhzfzq">
                <span className="c10 c5">7. CONTRIBUTION LICENSE</span>
              </h1>
              ...
              <h1 className="c18" id="h.yesr57xnm9tu">
                <span className="c10 c5">8. SUBMISSIONS</span>
              </h1>
              ...
              <h1 className="c18" id="h.3crz3o3a6ij9">
                <span className="c10 c5">9. SITE MANAGEMENT</span>
              </h1>
              ...
              <h1 className="c18" id="h.wv7t1lobm9zb">
                <span className="c10 c5">10. PRIVACY POLICY</span>
              </h1>
              ...
              <p className="c3">
                <span>
                  ...
                  <span className="c12">
                    <a
                      className="c4"
                      href="https://www.adzviser.com/privacy-policy"
                    >
                      https://www.adzviser.com/privacy-policy.
                    </a>
                  </span>
                  By using the Site, you agree to be bound by our Privacy Policy
                  posted on the Site, which is incorporated into these Terms of
                  ...
                  the Site, you are transferring your data to the United States,
                  and you agree to have your data transferred to and processed
                  in the United States.
                </span>
              </p>

              <h1 className="c18" id="h.xugo2edkhmv7">
                <span className="c5 c10">11. TERM AND TERMINATION</span>
              </h1>
              ...
              <h1 className="c18" id="h.iu1lqm4wjeyt">
                <span className="c10 c5">
                  12. MODIFICATIONS AND INTERRUPTIONS
                </span>
              </h1>
              ...
              <h1 className="c18" id="h.eq4v54prchk1">
                <span className="c10 c5">13. GOVERNING LAW</span>
              </h1>
              ...
              <h1 className="c18" id="h.swgejc3g5tbm">
                <span className="c10 c5">14. DISPUTE RESOLUTION</span>
              </h1>
              ...
              <h2 className="c17 c18__subtitle" id="h.5a11ogmxgikz">
                <span className="c7 c5">Binding Arbitration</span>
              </h2>
              ...
              <p className="c3">
                <span>
                  ...
                  <span className="c12">
                    <a className="c4" href="https://www.adr.org">
                      www.adr.org.
                    </a>
                  </span>
                  ...
                  will pay all arbitration fees and expenses. The arbitration
                  ...
                  will take place in California. Except as otherwise provided
              ...
              <p className="c3">
                <span>
                  ...
                  the state and federal courts located in Delaware, and the
              ...
              <h2 className="c17 c18__subtitle" id="h.5a11ogmxgikz">
                <span className="c7 c5">Restrictions</span>
              </h2>
              ...
              <h1 className="c18" id="h.swgejc3g5tbmfifteen">
                <span className="c10 c5">15. CORRECTIONS</span>
              </h1>
              ...
              <h1 className="c18" id="h.swgejc3g5tbmsixtin">
                <span className="c10 c5">16. DISCLAIMER</span>
              </h1>
              ...
              <h1 className="c18" id="h.swgejc3g5tbmseventeen">
                <span className="c10 c5">17. LIMITATIONS OF LIABILITY</span>
              </h1>
              ...
              <h1 className="c18" id="h.swgejc3g5tbmeighteen">
                <span className="c10 c5">18. INDEMNIFICATION</span>
              </h1>
              ...
              <h1 className="c18" id="h.swgejc3g5tbmnineteen">
                <span className="c10 c5">19. USER DATA</span>
              </h1>
              ...
              <h1 className="c18" id="h.swgejc3g5tbmtwenteen">
                <span className="c10 c5">
                  20. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
                </span>
              </h1>
              ...
              <h1 className="c18" id="h.swgejc3g5tbmtwenteenone">
                <span className="c10 c5">
                  21. CALIFORNIA USERS AND RESIDENTS
                </span>
              </h1>
              ...
              <h1 className="c18" id="h.swgejc3g5tbmtwenteentwo">
                <span className="c10 c5">22. MISCELLANEOUS</span>
              </h1>
              ...
              <h1 className="c18" id="h.swgejc3g5tbmtwenteenthree">
                <span className="c10 c5">23. CONTACT US</span>
              </h1>
              ...
              <div className="contact__text">
                <p className="c3 contact__text--spacing">
                  <span className="c1" style={{ fontWeight: "600" }}>
                    Adzviser LLC
                  </span>
                </p>
                <p className="c3 contact__text--spacing">
                  <span className="c1">United States</span>
                </p>

                <p className="c3 contact__text--spacing">
                  <span className="c1">Phone: (909) 927-7979</span>
                </p>
                <p className="c3 contact__text--spacing">
                  <span className="c1">zeyuan.gu@adzviser.com</span>
                </p>
              </div>
            </div>
          </div>
